...
public class MainActivityUser extends AppCompatActivity implements View.OnClickListener {
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_signup:
                ...
                if (validatorUserName()) {
                    ...
                    Intent intentWorker = new Intent(MainActivityUser.this,ActivityShowWorkerList.class);
    ...
    public void EnableRuntimePermission(){
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(MainActivityUser.this,
                Manifest.permission.CAMERA))
        {
            Toast.makeText(MainActivityUser.this,"CAMERA permission allows us to Access CAMERA app", Toast.LENGTH_LONG).show();
        ...
        {
            Toast.makeText(MainActivityUser.this,"READ_EXTERNAL_STORAGE allows us to Access CAMERA app", Toast.LENGTH_LONG).show();
        ...
        {
            Toast.makeText(MainActivityUser.this,"WRITE_EXTERNAL_STORAGE allows us to Access CAMERA app", Toast.LENGTH_LONG).show();

        }

        else {

            ActivityCompat.requestPermissions(MainActivityUser.this,new String[]{
        ...
        switch (RC) {
            ...
            case REQUEST_PERMISSION_CAMERA:
                ...
                if (PResult.length > 0 && PResult[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(MainActivityUser.this,"Permission Granted, Now your application can access CAMERA.", Toast.LENGTH_LONG).show();

                } else {

                    Toast.makeText(MainActivityUser.this,"Permission Canceled, Now your application cannot access CAMERA.", Toast.LENGTH_LONG).show();
